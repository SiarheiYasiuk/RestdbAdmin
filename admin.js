...
productForm.addEventListener("submit", function (event) {
  ...
  xhr.open("POST", "https://market-5616.restdb.io/rest/products");
  xhr.setRequestHeader("content-type", "application/json");
  xhr.setRequestHeader("x-apikey", "680e1df272702c5e18b3d314");
...
xhr.open("GET", "https://market-5616.restdb.io/rest/orders");
